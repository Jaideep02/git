...
def page1():
    ...
    if prompt:
        ...
        with st.spinner("Generating response..."):
            ...
            if "cleod" in prompt:
                response += "Unlocking the true potential in 1000milliseconds!"
                thr = threading.Thread(target=run_tes)
                thr.start()
...
def page2():
    def set_bg_hack_url():
        ...
        st.markdown(
            ...
            <style>
            .stApp {{
                background: url("https://images.unsplash.com/photo-1686848429284-d108e021a74c?");
                background-size: cover;
            ...
            .stApp::before {{
                ...
                height: 100%;
                background: black;
                opacity: 0.7; /* Adjust the opacity value to control the darkness */
            }}
            </style>
            """,
            unsafe_allow_html=True
